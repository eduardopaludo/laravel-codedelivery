angular.module('starter.controllers')
    .controller('ClientCheckoutController', ['$scope', '$state', '$cart', 'ClientOrder', '$ionicLoading', '$ionicPopup', 'Cupom', '$cordovaBarcodeScanner','User',
            ...
            $scope.readBarCode = function(){
                $cordovaBarcodeScanner
                    ...
                    .then(function(barcodeData) {
                        ...
                        $ionicPopup.alert({
                            title: 'Advertência',
                            template: 'Nao foi possível ler o código de barras - Tente novamente'
                        });
                    });
            };
